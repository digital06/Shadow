...
const fr: Dict = {
  ...
  'account.signin.subtitle': 'Connectez-vous via Tip4Serv pour consulter vos paiements et gérer vos abonnements.',
  ...
  'account.payments.empty.description': 'Vos achats apparaîtront ici dès votre première commande.',
...
const en: Dict = {
  ...
  'account.signin.subtitle': 'Sign in with Tip4Serv to view your payments and manage your subscriptions.',
  ...
  'account.tabs.payments': 'Payments',
  'account.tabs.subscriptions': 'Subscriptions',
  'account.profile.section_title': 'Profile information',
  ...
  'account.profile.registered_on': 'Registered on',
  'account.refresh': 'Refresh',
  'account.payments.loading': 'Loading history...',
  'account.payments.empty.title': 'No payments',
  'account.payments.empty.description': 'Your purchases will appear here once you place your first order.',
  ...
  'account.subs.empty.title': 'No subscriptions',
  'account.subs.empty.description': 'Your active subscriptions will appear here.',
  'account.subs.price': 'Price',
  'account.subs.cycle': 'Cycle',
  'account.subs.cycle_one_time': 'One-time',
  'account.subs.start': 'Start',
  'account.subs.expires_on': 'Expires on',
  'account.subs.next_payment': 'Next payment',
  'account.subs.unsubscribe': 'Unsubscribe',
  'account.subs.confirm_unsubscribe': 'Confirm the cancellation of this subscription?',
